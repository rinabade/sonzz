...
<head>
    ...
    <link rel="stylesheet" href="artistalbum.css">
</head>
<body>
    <div class="main-contaner">
        <div class="playlist-container">
            <div class="playlist">
                ...
                <div class="playlist-card">
                    ...
                    <a href="playlist.php"><h3 class="playlist-main-content">Profile</h3></a>
                </div>
            ...
            <div class="playing">
                <div class="top-header">
                    ...
                    <div class="search">
                        ...
                        <h3 class="data 1">
                                Bipul Cheetri   <button class="button">Follow</button>
                            </h3>
               ...
               <div class="playing-songs">
                     ...
                     <div class="playing-songs-container">
                        <div class="songs-container1">
                             ...
                             <div class="songs-container11">
                                 <h2 class="songs-text">Mountain High</h2>
                     ...
                     <div class="playing-songs-container">
                        <div class="songs-container1">
                             ...
                             <div class="songs-container11">
                                 <h2 class="songs-text">Asaar</h2>
                                 <h4 class="songs-details"></h4>
                             </div> 
                        </div>
                        <div class="songs-contaner2">
                            <h3 class="songs-text">3:30</h3>
                        </div>
                     </div>
                     <div class="playing-songs-container">
                        <div class="songs-container1">
                             ...
                             <div class="songs-container11">
                                 <h2 class="songs-text">Ram sailee</h2>
                                 <h4 class="songs-details"> </h4>
                             </div> 
                        </div>
                        <div class="songs-contaner2">
                     ...
                     <div class="playing-songs-container">
                        <div class="songs-container1">
                             ...
                             <div class="songs-container11">
                                 <h2 class="songs-text">Wildfire(Dadhelo)</h2>
                                 <h4 class="songs-details"> </h4>
                             </div> 
                        </div>
                        <div class="songs-contaner2">
                     ...
                     <div class="playing-songs-container">
                        <div class="songs-container1">
                             ...
                             <div class="songs-container11">
                                 <h2 class="songs-text">Deorali Darah</h2>
                                 <h4 class="songs-details">  </h4>
                             </div> 
                        </div>
                        <div class="songs-contaner2">
                     ...
                     <div class="playing-songs-container">
                        <div class="songs-container1">
                             ...
                             <div class="songs-container11">
                                 <h2 class="songs-text">Raili Garee</h2>
                                 <h4 class="songs-details"> </h4>
                             </div> 
                        </div>
                        <div class="songs-contaner2">
        ...
        <div class="music-player"> 
            <div class="player-content-1">
                <img src="/assets/album.jpg" class="palyer-image" alt="">
