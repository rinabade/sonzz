                              ...
                              <div class="form">                      
                                  <form action="edit.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="element">
                                      ...
                                      <input type="text"  placeholder="Firstname" name="fname" id="fname" value="<?php echo $row['fname']; ?>" >
                                    </div>
                
                                    <div class="element">
                                      <label for="lname"><b>Lastname</b></label>
                                      <input type="text"  placeholder="Lastname" name="lname" id="lname" value="<?php echo $row['lname']; ?>">
                                    </div>
                                    ...
                                    <!-- <div class="element">
                                      ...
                                      <input type="text"  placeholder="Phone number" name="Phone_number" id="phone" value="<?php echo $row['fname']; ?>">
                                    </div> -->
                                    
                                    <div class="element">
                                      <label for="address"><b>Address</b></label>
                                      <input type="text"  placeholder="Address" name="address" id="address" value="<?php echo $row['address']; } ?>">
                                    </div>
